...
/**
* @author 胡富国
* @description 针对表【news_count】的数据库操作Service实现
* @createDate 2022-06-23 15:28:18
*/
@Service
public class NewsCountServiceImpl extends ServiceImpl<NewsCountMapper, NewsCount>
    implements NewsCountService{
